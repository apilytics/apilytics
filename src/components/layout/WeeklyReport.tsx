  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        />
        <div>
          <h6 style={{ color: 'white', fontSize: 25, margin: 0 }}>Weekly report for {name}</h6>
            ...
            {requestsData.map(({ method, endpoint, totalRequests }) => (
              <li key={endpoint} style={{ display: 'flex', justifyContent: 'space-between' }}>
                <div style={{ display: 'inline-flex', gap: 5 }}>
                  <span
                    style={{ color: HTTP_METHOD_COLORS[method as keyof typeof HTTP_METHOD_COLORS] }}
                  >
                    {method}
                  </span>
        ...
        <div style={{ width: '20rem' }}>
          ...
          <ul style={{ margin: 0, padding: 0 }}>
            {statusCodeData.map(({ statusCode, requests }) => (
              <li key={statusCode} style={{ display: 'flex', justifyContent: 'space-between' }}>
        ...
        <div style={{ width: '20rem' }}>
          ...
          <ul style={{ margin: 0, padding: 0 }}>
            {countryData.map(({ country, countryCode, requests }) => (
              <li key={countryCode} style={{ display: 'flex', justifyContent: 'space-between' }}>
                <div style={{ display: 'inline-flex', gap: 5 }}>
      ...
      >
        ...
        <div style={{ width: '20rem' }}>
          ...
          <ul style={{ margin: 0, padding: 0 }}>
            <li style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'white' }}>avg</span>
              <span style={{ color: 'white' }}>{formatBytes(avgPercentileData?.requestSize)}</span>
            </li>
            <li style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'white' }}>p50</span>
              <span style={{ color: 'white' }}>{formatBytes(p50PercentileData?.requestSize)}</span>
            </li>
            <li style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'white' }}>p75</span>
              <span style={{ color: 'white' }}>{formatBytes(p75PercentileData?.requestSize)}</span>
            </li>
            <li style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'white' }}>p90</span>
              <span style={{ color: 'white' }}>{formatBytes(p90PercentileData?.requestSize)}</span>
            </li>
            <li style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'white' }}>p95</span>
              <span style={{ color: 'white' }}>{formatBytes(p95PercentileData?.requestSize)}</span>
            </li>
            <li style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'white' }}>p99</span>
              <span style={{ color: 'white' }}>{formatBytes(p99PercentileData?.requestSize)}</span>
            </li>
          </ul>
        </div>
        ...
        <div style={{ width: '20rem' }}>
          ...
          <ul style={{ margin: 0, padding: 0 }}>
            <li style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'white' }}>avg</span>
              <span style={{ color: 'white' }}>{formatBytes(avgPercentileData?.responseSize)}</span>
            </li>
            <li style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'white' }}>p50</span>
              <span style={{ color: 'white' }}>{formatBytes(p50PercentileData?.responseSize)}</span>
            </li>
            <li style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'white' }}>p75</span>
              <span style={{ color: 'white' }}>{formatBytes(p75PercentileData?.responseSize)}</span>
            </li>
            <li style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'white' }}>p90</span>
              <span style={{ color: 'white' }}>{formatBytes(p90PercentileData?.responseSize)}</span>
            </li>
            <li style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'white' }}>p95</span>
              <span style={{ color: 'white' }}>{formatBytes(p95PercentileData?.responseSize)}</span>
            </li>
            <li style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'white' }}>p99</span>
              <span style={{ color: 'white' }}>{formatBytes(p99PercentileData?.responseSize)}</span>
            </li>
          </ul>
        </div>
      </div>
      ...
      >
        <div style={{ width: '20rem' }}>
          ...
          <ul style={{ margin: 0, padding: 0 }}>
            <li style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'white' }}>avg</span>
              <span style={{ color: 'white' }}>{formatCpuUsage(avgPercentileData?.cpuUsage)}</span>
            </li>
            <li style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'white' }}>p50</span>
              <span style={{ color: 'white' }}>{formatCpuUsage(p50PercentileData?.cpuUsage)}</span>
            </li>
            <li style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'white' }}>p75</span>
              <span style={{ color: 'white' }}>{formatCpuUsage(p75PercentileData?.cpuUsage)}</span>
            </li>
            <li style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'white' }}>p90</span>
              <span style={{ color: 'white' }}>{formatCpuUsage(p90PercentileData?.cpuUsage)}</span>
            </li>
            <li style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'white' }}>p95</span>
              <span style={{ color: 'white' }}>{formatCpuUsage(p95PercentileData?.cpuUsage)}</span>
            </li>
            <li style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'white' }}>p99</span>
              <span style={{ color: 'white' }}>{formatCpuUsage(p99PercentileData?.cpuUsage)}</span>
            </li>
          </ul>
        </div>
        ...
        <div style={{ width: '20rem' }}>
          ...
          <ul style={{ margin: 0, padding: 0 }}>
            <li style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'white' }}>avg</span>
              <span style={{ color: 'white' }}>{formatBytes(avgPercentileData?.memoryUsage)}</span>
            </li>
            <li style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'white' }}>p50</span>
              <span style={{ color: 'white' }}>{formatBytes(p50PercentileData?.memoryUsage)}</span>
            </li>
            <li style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'white' }}>p75</span>
              <span style={{ color: 'white' }}>{formatBytes(p75PercentileData?.memoryUsage)}</span>
            </li>
            <li style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'white' }}>p90</span>
              <span style={{ color: 'white' }}>{formatBytes(p90PercentileData?.memoryUsage)}</span>
            </li>
            <li style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'white' }}>p95</span>
              <span style={{ color: 'white' }}>{formatBytes(p95PercentileData?.memoryUsage)}</span>
            </li>
            <li style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'white' }}>p99</span>
              <span style={{ color: 'white' }}>{formatBytes(p99PercentileData?.memoryUsage)}</span>
            </li>
          </ul>
        </div>
        ...
        <div style={{ width: '20rem' }}>
          ...
          <ul style={{ margin: 0, padding: 0 }}>
            <li style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'white' }}>avg</span>
              <span style={{ color: 'white' }}>{formatBytes(avgPercentileData?.memoryTotal)}</span>
            </li>
            <li style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'white' }}>p50</span>
              <span style={{ color: 'white' }}>{formatBytes(p50PercentileData?.memoryTotal)}</span>
            </li>
            <li style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'white' }}>p75</span>
              <span style={{ color: 'white' }}>{formatBytes(p75PercentileData?.memoryTotal)}</span>
            </li>
            <li style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'white' }}>p90</span>
              <span style={{ color: 'white' }}>{formatBytes(p90PercentileData?.memoryTotal)}</span>
            </li>
            <li style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'white' }}>p95</span>
              <span style={{ color: 'white' }}>{formatBytes(p95PercentileData?.memoryTotal)}</span>
            </li>
            <li style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'white' }}>p99</span>
              <span style={{ color: 'white' }}>{formatBytes(p99PercentileData?.memoryTotal)}</span>
            </li>
          </ul>
        </div>
      </div>
