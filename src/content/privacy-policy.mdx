...
codes, request/response sizes, user agents, execution times, and package version
information. The integration must be installed manually by you, and you are
...
that email info from us, by opening the unsubscribe link from any email that you
have received.
