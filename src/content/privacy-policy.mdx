...
Protection Regulation (GDPR). Last updated on 2022-02-03.
...
codes, request/response sizes, user agents, execution times, and package
...
partners include our hosting providers (<ExternalLink href="https://vercel.com">Vercel</ExternalLink>, <ExternalLink href="https://aws.amazon.com">AWS</ExternalLink>) and email service (<ExternalLink href="https://www.namecheap.com">Namecheap</ExternalLink>).
In these situations, we will take the necessary steps to protect your information,
...
(<ExternalLink href="https://www.tietosuoja.fi">www.tietosuoja.fi</ExternalLink>).
