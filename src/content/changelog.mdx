...
- Add support for dynamic routes. You can now configure
  ...
  endpoints will be combined into a single onein your dashboard.
- Fix issue of small endpoints not being clickable in the dashboard - not the endpoint names are clickable links instead.
