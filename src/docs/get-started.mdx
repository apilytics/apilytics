...
<Link href={routes.register}>
  <Button className="btn-outline btn-primary mt-4">Sign up here!</Button>
</Link>

<br />
<br />

#### 2. Grab your API key 🔑 {#api-key}
...
After you've created your origin, you will be taken to the dashboard, and you can see your API key.
...
#### 3. Install the open source middleware 👨‍💻 {#install-middleware}
...
- <Link href={routes.python + '#flask'}>Flask</Link>
