...
The memory usage is shown similarly to the CPU metrics, except these ones have absolute values.
...
Also, remeber that we're still getting started and our DMs are open!
