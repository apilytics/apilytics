...
Now all requests directed to e.g. `/blogs/123`, `/blogs/456`, `/users/johndoe` and `/users/janedoe` will be included in these endpoints in our visualization.
...
You can also later modify or delete the dynamic routes to split up of your data.
