...
and our [documentation](/docs/api) shows exactly how to use it.
...
Our [documenation](/documentation) shows you up-to-date information about the metrics you can log and how to use them.
...
which you can find in our <ExternalLink href="https://github.com/apilytics">GitHub</ExternalLink>.
...
P.S. We're happy to help if there's anything we can do to help with using the API, just drop us a [message](/contact).
